package com.citytratters.myPreferance;
...
public class MyPreference {
    ...
    public static void setPreference(Context context, String key, String val) {
        SharedPreferences settings = MyPreference.getSharedPreferences(context);
    ...
    public static boolean setPreferenceArray(Context mContext , String key, ArrayList<String> array) {
        SharedPreferences prefs = MyPreference.getSharedPreferences(mContext);
    ...
    {
        SharedPreferences settings = MyPreference.getSharedPreferences(c);
    ...
    {
        SharedPreferences settings = MyPreference.getSharedPreferences(con);
    ...
    public static String getPreference(Context context, String key) {
        SharedPreferences prefs = MyPreference.getSharedPreferences(context);
