...
import com.citytratters.interfaces.CurrentLocationResult
...
class CurrentLocationProvider(var context: Activity, currentLocationResult: CurrentLocationResult) :
    ...
    var currentLocationResult: CurrentLocationResult
    val instance: GoogleApiClient
    ...
    init {
        this.currentLocationResult = currentLocationResult
